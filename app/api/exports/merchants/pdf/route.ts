...
export async function GET(request: NextRequest) {
  try {
    ...
    const baseApiUrl = "https://redcollection.onrender.com/api/v1/exports/merchants/pdf";
    ...
    const filename = headers.get("content-disposition")?.match(/filename="(.+)"/)?.[1] || `merchants_${new Date().toISOString().split("T")[0]}.pdf`;
