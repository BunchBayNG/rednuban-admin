...
function Services() {
  ...
  const handleExport = (data: {
    ...
    const services = [
      { ServiceName: "Open Account", ServiceFee: "0.00", ServiceType: "Fiat", ServiceCap: "500" },
      { ServiceName: "Virtual Transaction", ServiceFee: "0.00", ServiceType: "Percentage with Cap", ServiceCap: "500" },
      { ServiceName: "Merchant Setup", ServiceFee: "0.00", ServiceType: "Fiat", ServiceCap: "500" },
    ];
    const exportData = services
      .map((service) =>
        Object.fromEntries(
          Object.entries(service).filter(([key]) => data.fields[key])
        )
      );
